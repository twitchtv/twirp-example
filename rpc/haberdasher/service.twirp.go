...
func NewHaberdasherProtobufClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) Haberdasher {
	...
	serviceURL += baseServicePath(clientOpts.PathPrefix(), "twitch.twirp.haberdasher", "Haberdasher")
	urls := [1]string{
		serviceURL + "MakeHat",
	}
...
func (c *haberdasherProtobufClient) MakeHat(ctx context.Context, in *Size) (*Hat, error) {
	ctx = ctxsetters.WithPackageName(ctx, "twitch.twirp.haberdasher")
...
const HaberdasherPathPrefix = "/twirp/twitch.twirp.haberdasher.Haberdasher/"
...
func (s *haberdasherServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	if pkgService != "twitch.twirp.haberdasher.Haberdasher" {
...
func (s *haberdasherServer) PathPrefix() string {
	return baseServicePath(s.pathPrefix, "twitch.twirp.haberdasher", "Haberdasher")
}
...
var twirpFileDescriptor0 = []byte{
	...
	,
}
